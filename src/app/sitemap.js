...
export default function sitemap() {
  ...
  const ruRoutes = ['/ru', '/ru/products', '/ru/products/mini-crossbody', '/ru/custom-service', '/ru/factory', '/ru/about', '/ru/contact', '/ru/resources', '/ru/custom-waist-bags', '/ru/custom-crossbody-bags', '/ru/custom-cosmetic-bags', '/ru/custom-tote-bags', '/ru/blog'];
  return [
    ...
    ...ruBlogPosts.map((post) => ({ url: `${siteUrl}/ru/blog/${post.slug}`, lastModified: post.date })),
