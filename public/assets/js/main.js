(function(){
  ...
  function whatsappUrl(product=null, variant=''){
    ...
    const message = selectedProduct
      ? `Hi, I'm interested in your ${selectedProduct.title} (${selectedProduct.model})${selectedVariant ? ` - ${selectedVariant}` : ''}. Please send MOQ tiers, sample cost and lead time.`
      : `Hi, I'm interested in your custom bag products. Please send your product catalog, MOQ tiers, sample cost and lead time.`;
