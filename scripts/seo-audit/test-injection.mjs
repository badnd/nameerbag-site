...
const temp = await fs.mkdtemp(path.join(os.tmpdir(), "seo-audit-injection-"));
const server = http.createServer((request, response) => {
  ...
  if (request.url === "/sitemap.xml") {
    ...
    response.end(`<!doctype html><html lang="en"><head><title>Fixture</title><meta name="description" content="fixture"><link rel="canonical" href="${origin}/"><link rel="alternate" hreflang="en" href="${origin}/"><link rel="alternate" hreflang="ru" href="${origin}/"><link rel="alternate" hreflang="x-default" href="${origin}/"></head><body><a href="/missing">Broken fixture link</a><p>Unit price: $19.99. MOQ 50-300 pcs.</p><p>annawei@nameerbag.com 008615102249548 15102249548 Anna Wei</p></body></html>`);
...
const expected = ["LINK_BROKEN", "PRICE_PUBLIC", "MOQ_RANGE"];
